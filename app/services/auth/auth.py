...
from auth_service.repository.exceptions import UsernameError

from auth_service.repository.auth_repository import IUserRepository
from auth_service.services.auth.users import User
from auth_service.services.auth.exceptions import AuthUsernameError
